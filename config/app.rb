Volt.configure do |config|
  ...
  #######################################
  config.domain = 'asheehan.com'
  config.app_name = 'Asheehan'
  config.mailer.from = 'Asheehan <no-reply@asheehan.com>'
  ...
  #
  config.app_secret = '9SZ96M8g0F7RozJnloaoP94EvSeioPe1wFYzv2CA2yPstw-wOUhr601peWKsBb2e2Yw'
